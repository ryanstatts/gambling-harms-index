---
title: "The GHSI Measurement tools"
description: |
...
- **Resources** – including financial hardship, work or study disruption, and legal consequences
-  **Relationships** – including conflict, breakdown, and social isolation


At the heart of the measure is **recovery**, which captures progress through four core areas: **control, insight, ownership,** and **behaviour change.**
...
-  **GHSI score cam be inter-converted with the Problem Gambling Severity Index (PGSI)**, making it possible to compare data or transition smoothly from older tools. 
...
Unlike many existing measures, the GHSI tools were designed not just for analysis—but for use with real people. The language is clear, the questions are meaningful, and the scoring reflects what people themselves say matters most.


Whether you're a frontline worker, academic, commissioner or advocate, these tools offer a more human, accurate and actionable way to understand and respond to gambling harm.
