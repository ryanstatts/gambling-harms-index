...
- **Minimal (< -2.0 logits)**: Few or no gambling-related harms
- **Low (-2.0 to -1.0 logits)**: Minor harms with limited impact on wellbeing
- **Moderate (-1.0 to 0.5 logits)**: Noticeable harms affecting some areas of life
- **Moderately Severe (0.5 to 2.0 logits)**: Significant harms with substantial impact
- **Severe (> 2.0 logits)**: Extensive harms with major consequences across multiple domains
