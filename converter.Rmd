...
The converter tool lets you convert any score on one of our benchmarked scales to a *Rasch Measure*. The *Rasch Measure* lets you compare to other scales that we also have benchmarked as well as comparing gambling-related harms to decrements to wellbeing. Typical GHSI-10 scores are roughly equivalent to PGSI. 
...
- **GHS-10 (Gambling Harms Scale - 10)**: A 10-item scale assessing a range of negative consequences of gambling


**As we work on updating our benchmarking of health utilities, the converter tool is currently offline. Please check back soon for an updated version of the tool.**
